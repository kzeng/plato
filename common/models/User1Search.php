...
/**
 * User1Search represents the model behind the search form of `common\models\User1`.
 */
class User1Search extends User1
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'auth_key', 'access_token', 'password_hash', 'password_reset_token', 'email', 'verification_token', 'mobile'], 'safe'],
        ];
    }
