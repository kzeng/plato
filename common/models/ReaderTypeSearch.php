...
/**
 * ReaderTypeSearch represents the model behind the search form of `common\models\ReaderType`.
 */
class ReaderTypeSearch extends ReaderType
{
    /**
     * {@inheritdoc}
     */
